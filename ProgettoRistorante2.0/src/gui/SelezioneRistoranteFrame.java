...
public class SelezioneRistoranteFrame extends JFrame {
	...
	public SelezioneRistoranteFrame(Controller c) {
		...
		JComboBox listaRistorantiBox = new JComboBox(ristorantiString);
		listaRistorantiBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			}
		});
		//comboBox.setModel(new DefaultComboBoxModel(new String[] {"NomeRistorante1", "NomeRistorante2", "NomeRistorante3"}));
		listaRistorantiBox.setToolTipText("");
		listaRistorantiBox.setBounds(101, 113, 179, 23);
		contentPane.add(listaRistorantiBox);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controller.ristoranteSelezionato(listaRistorantiBox.getSelectedIndex());
